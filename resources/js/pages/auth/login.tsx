        ...
        <AuthLayout title="Log in to your account" description="Enter your email and password below to log in">
            ...
            <div className="text-center">
                <Link
                    ...
                    className="inline-flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-green-600 bg-green-50 border border-green-200 rounded-md hover:bg-green-100 hover:text-green-700 transition-colors"
                >
                    <Phone className="w-4 h-4 mr-2" />
                    Login dengan Nomor Telepon (Orang Tua)
                </Link>
                <p className="mt-2 text-xs text-gray-500">
                    Khusus untuk orang tua siswa - Login menggunakan OTP WhatsApp
                </p>
            </div>
